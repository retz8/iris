...
**Status:** ⚠️ FAIR ![Tool-Calling](https://img.shields.io/badge/Execution-Tool--Calling-orange)
  ...
  "children": [
    ...
    },
    {
      ...
      "import_details": {
        ...
        "source": "three/examples/jsm/loaders/PLYLoader.js"
      },
      "fields": {
        "source": [
          {
    ...
    },
    {
      ...
      "import_details": {
        ...
        "source": "three/examples/jsm/exporters/OBJExporter.js"
      },
      "fields": {
        "source": [
          {
...
| Shallow AST | 310 | 49,594B | Semantic analysis |
| **Reduction** | **11.80x** | **0.70x** | **Efficiency gain** |
...
| Metric | Value |
|--------|-------|
| Node Reduction Ratio | 11.80x |
| Context Compression Ratio | 0.70x |
| Comment Retention Score | 91.3% |
| Full AST Nodes | 3657 |
| Shallow AST Nodes | 310 |
| Full AST Estimated Tokens | 12,799 |
| Shallow AST Estimated Tokens | 1,085 |
| Source Bytes | 34,674 |
| JSON Bytes | 49,594 |
...
- Tokens/Second: 849.4 tok/s
- Input: 21,483 tok | Output: 1,120 tok | Total: 22,603 tok
...
```json
{
  "file_intent": "Modeling and simulation orchestrator: manages the loading, updating, and alignment of human and wheelchair models in a 3D environment.",
  "responsibilities": [
    {
      "id": "model-loading-and-updating",
      "label": "Model Loading & Updating",
      "description": "Handles the loading and updating of human and wheelchair models based on parameters and user inputs.",
      "elements": {
        "functions": [
          "loadHumanModel",
          "loadWheelchairModel",
        ...
        "imports": [
          ...
          "createManualWheelchair from ./modules/manualWheelchair.js",
          "createPoweredWheelchair from ./modules/poweredWheelchair.js",
          "getHumanModelWorldCoordinates from ./utils/meshUtils.js",
          "optimizeHumanAlignment from ./utils/meshUtils.js"
        ],
        "types": [],
        "constants": []
      },
    ...
    },
    {
      ...
      "description": "Validates and updates wheelchair parameters based on user input and predefined constraints.",
      "elements": {
        "functions": [
    ...
    },
    {
      ...
      "description": "Manages the graphical user interface for user interactions and updates.",
      "elements": {
        "functions": [
        ...
        "imports": [
          "createGUIWithAnth from ./modules/guiManager.js"
        ],
        "types": [],
        "constants": []
      },
  ...
  "metadata": {
    "notes": "The file serves as a central hub for managing the interaction between human and wheelchair models, ensuring they are loaded, updated, and aligned correctly based on user inputs and parameters."
  }
}
```
...
|---|------|-----------|------|----------|-----------|
| 1 | `refer_to_source_code` | 1-50 | 1,593B | 0.00s | 17:10:09 |
| 2 | `refer_to_source_code` | 311-332 | 525B | 0.00s | 17:10:09 |
| 3 | `refer_to_source_code` | 338-363 | 826B | 0.00s | 17:10:09 |
| 4 | `refer_to_source_code` | 368-388 | 778B | 0.00s | 17:10:09 |
| 5 | `refer_to_source_code` | 393-452 | 2,073B | 0.00s | 17:10:09 |
| 6 | `refer_to_source_code` | 418-466 | 1,676B | 0.00s | 17:10:09 |
| 7 | `refer_to_source_code` | 475-562 | 2,345B | 0.00s | 17:10:09 |
| 8 | `refer_to_source_code` | 582-641 | 1,695B | 0.00s | 17:10:09 |
| 9 | `refer_to_source_code` | 646-687 | 1,205B | 0.00s | 17:10:09 |
| 10 | `refer_to_source_code` | 698-734 | 1,215B | 0.00s | 17:10:09 |
| 11 | `refer_to_source_code` | 739-757 | 762B | 0.00s | 17:10:09 |
| 12 | `refer_to_source_code` | 765-804 | 1,423B | 0.00s | 17:10:09 |
| 13 | `refer_to_source_code` | 809-838 | 798B | 0.00s | 17:10:09 |
| 14 | `refer_to_source_code` | 848-870 | 657B | 0.00s | 17:10:09 |
| 15 | `refer_to_source_code` | 878-894 | 540B | 0.00s | 17:10:09 |
| 16 | `refer_to_source_code` | 900-911 | 372B | 0.00s | 17:10:09 |
| 17 | `refer_to_source_code` | 943-978 | 2,045B | 0.00s | 17:10:09 |
| 18 | `refer_to_source_code` | 983-1015 | 740B | 0.00s | 17:10:09 |
| 19 | `refer_to_source_code` | 1020-1033 | 450B | 0.00s | 17:10:09 |
| 20 | `refer_to_source_code` | 1036-1145 | 3,106B | 0.00s | 17:10:09 |
| 21 | `refer_to_source_code` | 1148-1154 | 194B | 0.00s | 17:10:09 |

### Tool Call Details

#### Call #1: refer_to_source_code

**Timestamp:** 17:10:09.472  
**Arguments:**
...
**Result Size:** 194 bytes

**Source Code Retrieved:**

```javascript
$(document).ready(function () {
  // Wait until the PCA data is loaded before rendering
...
**Integrity Score:** `72.6%`

**Checks:** 225/310 passed
