...
**No background, border, padding, or box-shadow on the code block.** The code renders directly on the white email background with no card or box framing.
...
Replace the `<pre style="..."><code>PASTE_SNIPPET_HERE</code></pre>` block in the template with the syntax-highlighted `<div>` from Step 1. The first character inside the `<div>` after the closing `>` must be the first token of the code — no leading newline.
...
<body style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.6;color:#24292f;background:#ffffff;">
  <div style="max-width:480px;margin:0 auto;padding:20px;">
    ...
    <pre style="font-family:Consolas,Monaco,'Courier New',monospace;font-size:13px;line-height:1.6;overflow-x:auto;color:#24292f;margin:0 0 24px 0;white-space:pre-wrap;word-wrap:break-word;"><code>PASTE_SNIPPET_HERE</code></pre>
    ...
    <div style="padding-top:20px;border-top:1px solid #d0d7de;font-size:13px;color:#57606a;">
      LANGUAGES_LIST | <a href="https://iris-codes.com/snippet/unsubscribe?token=UNSUBSCRIBE_TOKEN" style="color:#57606a;text-decoration:none;">Unsubscribe</a>
    </div>
